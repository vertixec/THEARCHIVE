    ...
    <div id="view-content">
      <header className="pt-12 pb-6 px-6 bg-panel/30">
        <div className="w-full text-left">
          ...
          <h1 id="view-title" className="font-anton text-6xl md:text-8xl text-white uppercase tracking-tighter leading-[0.8] mb-4">The Archive</h1>
          <p id="view-desc" className="font-mono text-xs text-white/60 border-l border-acid pl-4 max-w-lg uppercase tracking-wider">Central repository for prompts and AI creative references.</p>
        </div>
      </header>
